<template>
	<transition name='list-fade'>
		<div @click='hide' v-show='showFlag' id="playlist">
			<div @click.stop class="list-wrapper">
				...
				<scroll ref='listContent' :data='sequenceList' class="list-content">
					<transition-group name='list' tag='ul'>
						<li ref='listItem' @click='selectItem(item, index, $event)' :key='item.id' v-for='(item, index) in sequenceList' class="item">
							<i class="current" :class='getCurrentIcon(item)'></i>
							<span class="text">{{item.name}}</span>
							<span @click.stop='changeFavorite(item, $event)' class="like">
			...
			<confirm @confirm='confirmClear' ref='confirm' text='是否清空播放列表' confirmBtnText='清空' />
